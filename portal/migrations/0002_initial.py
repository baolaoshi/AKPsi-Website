...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'portal_brother', (
            ...
            ('major', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True)),
            ('hometown', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True)),
            ...
            ('quote', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
            ('quote_author', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True)),
